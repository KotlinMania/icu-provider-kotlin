...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `IcuProvider.swiftmodule/`
...
//      `import IcuProvider` above would fail at compile time.
//
//   2. The static archive `libIcuProvider.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "IcuProvider" }` and
//      `flattenPackage = "io.github.kotlinmania.icuprovider"` configuration in
...
//      via the `IcuProviderLibrary` product.
//
