...
kotlin {
    ...
    val xcf = XCFramework("IcuProvider")

    macosArm64 {
        binaries.framework { baseName = "IcuProvider"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "IcuProvider"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "IcuProvider"
        flattenPackage = "io.github.kotlinmania.icuprovider"
    }

    android {
        namespace = "io.github.kotlinmania.icuprovider"
        compileSdk = 34
        minSdk = 24
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                // Upstream src/lib.rs does `pub use log` under the `logging` feature.
...
mavenPublishing {
    ...
    coordinates(group.toString(), "icu-provider-kotlin", version.toString())
    ...
    pom {
        ...
        scm {
            url.set("https://github.com/KotlinMania/icu-provider-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/icu-provider-kotlin.git")
...
val fullTargetBuildTaskNames = setOf(
    ...
    "assembleIcuProviderXCFramework",
)
