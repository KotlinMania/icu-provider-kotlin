...
This file is the quick-reference operating contract for icu-provider-kotlin. The longer
...
icu-provider-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`icu_provider`](https://crates.io/crates/icu_provider). Upstream Rust is the behavioral oracle while the
